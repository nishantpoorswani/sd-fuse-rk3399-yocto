...
function usage() {
       echo "Usage: $0 DEVICE <debian|buildroot|friendlycore-arm64|friendlydesktop-arm64|lubuntu|eflasher|yocto>"
       exit 0
}
...
case ${2,,} in
debian* | buildroot* | friendlycore* | friendlydesktop* | lubuntu* | yocto*)
	;;
eflasher*)
